package com.springboot.backend.microservicios.app.respuestas.controllers;
...
import com.springboot.backend.microservicios.app.respuestas.services.RespuestaService;
...
public class RespuestaController {
	...
	public ResponseEntity<?> obtenerRespuestaPorAlumnoPorExamen(@PathVariable Long alumnoId, @PathVariable Long examenId){
		Iterable<Respuesta> respuestas = service.findRespuestaByAlmunoByExamen(alumnoId, examenId);
		return ResponseEntity.ok(respuestas);
	}
	@GetMapping("/alumno/{alumnoId}/examenes-respondidos")
	public ResponseEntity<?> obtenerExamenesIdsConRespuestasAlumno(@PathVariable Long alumnoId){
		Iterable<Long> examenesIds = service.findExamenesIdsConRespuestasByAlmuno(alumnoId);
